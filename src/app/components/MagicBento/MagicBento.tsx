...
const DEFAULT_GLOW_COLOR = '244, 124, 54';
    ...
    <>
      ...
      <div className="card-grid bento-section" ref={gridRef}>
        {cardData.map((card, index) => {
          ...
          if (enableStars) {
            return (
              <ParticleCard key={index} className={baseClassName} style={cardStyle} disableAnimations={shouldDisableAnimations} particleCount={particleCount} glowColor={cardGlowColor} enableTilt={enableTilt} clickEffect={clickEffect} enableMagnetism={enableMagnetism}>
                {content}
              </ParticleCard>
            );
          }
